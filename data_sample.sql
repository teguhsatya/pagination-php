CREATE TABLE IF NOT EXISTS data_sample (
    ...
    `address` VARCHAR(31) CHARACTER SET utf8,
    `city` VARCHAR(19) CHARACTER SET utf8,
    `county` VARCHAR(20) CHARACTER SET utf8,
    `state` VARCHAR(2) CHARACTER SET utf8,
    `zip` INT,
    `phone1` VARCHAR(12) CHARACTER SET utf8,
    `phone2` VARCHAR(12) CHARACTER SET utf8,
    `email` VARCHAR(34) CHARACTER SET utf8,
    `web` VARCHAR(42) CHARACTER SET utf8
);
